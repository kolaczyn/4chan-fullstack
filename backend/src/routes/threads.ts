...
router.get('/popular', async (req: Req, res: Res) => {
...
router.get('/:board', async (req: Req, res: Res) => {
...
router.get('/:board/:id', async (req: Req, res: Res) => {
...
router.post('/:board', async (req: Req, res: Res) => {
  const { board } = req.params;
